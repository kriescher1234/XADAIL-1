...
MissingFilesSearch.exe /path:"%BATCH_DIR%DAIL" /GrimDawnPath:"E:\SteamLibrary\steamapps\common\Grim Dawn" /IgnorePattern:"\sounds\;petskill_abomination_scaling;Class29;passive_totaldamageabsorption01;perlevelx100;defense_undeadresists;resist_undead;melee_lifeleech_01;armor_passive;trap_resists;loottables;old combat directory;lootaffixes;m002_mutantarml01;m002_mutantarmr01"
